...
export const LLM_PRESETS: LlmPreset[] = [
  ...
  { label: 'Anthropic (Claude Haiku 4.5)', baseUrl: 'https://api.anthropic.com/v1', model: 'claude-haiku-4-5-20251001' },
  { label: 'Anthropic (Claude Sonnet 4.6)', baseUrl: 'https://api.anthropic.com/v1', model: 'claude-sonnet-4-6' },
