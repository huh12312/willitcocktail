...
export type ProviderChoice = 'auto' | 'litert-lm' | 'cloud' | 'heuristic';
...
export const LLM_PRESETS: LlmPreset[] = [
  ...
  // Anthropic's native API uses /v1/messages with x-api-key headers — not
  // compatible with the /chat/completions + Bearer-token shape used here.
  // Use an OpenAI-compatible proxy in front of Anthropic if needed.
