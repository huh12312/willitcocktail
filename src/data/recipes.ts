...
const CURATED_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    glass: 'highball',
    garnish: 'Lime wedge',
    instructions: 'Build in an ice-filled highball glass. Pour vodka, then grapefruit juice, then top with cranberry juice. Garnish with a lime wedge.',
    source: 'cocktailfyi',
    ingredients: [
      { ingredientId: 'vodka', amountMl: 45, amountDisplay: '1.5 oz', position: 1 },
      { ingredientId: 'cranberry_juice', amountMl: 90, amountDisplay: '3 oz', position: 2 },
      { ingredientId: 'grapefruit_juice', amountMl: 30, amountDisplay: '1 oz', position: 3 },
    ],
  },
  {
    id: 'dark_stormy',
